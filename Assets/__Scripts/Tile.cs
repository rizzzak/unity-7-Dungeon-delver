...
public class Tile : MonoBehaviour
{
    ...
    public void SetTile(int eX, int eY, int eTileNum = -1)
    {
        ...
        gameObject.name = x.ToString("D3") + "x" + y.ToString("D3");//D3=decimal 3-digit format
        if (eTileNum == -1)
